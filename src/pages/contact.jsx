...
const Contact = () => {
  return (
    <>
      <section className="dark:bg-black flex flex-col lg:pt-8 2xl:pt-12 items-center justify-center gap-10 h-screen">
        <h1 className="text-4xl 2xl:text-6xl font-bold flex gap-5 text-[#91a31d] dark:text-slate-400 ">
          Contact Me
        </h1>
        <div className="flex flex-col lg:grid grid-cols-2 lg:h-72 2xl:h-96 lg:w-4/5">
          <div className="lg:border p-5 lg:p-10">
            <ul className="flex flex-col gap-10">
              ...
              <li className="flex items-center gap-8">
                <img
                  src="/images/github2-light.png"
                  alt=""
                  className="w-16 2xl:w-20 dark:hidden"
                />
                <img
                  src="/images/github2-dark.png"
                  alt=""
                  className="w-16 2xl:w-20 hidden dark:block"
                />
                <p className="dark:text-slate-400 font-medium">
          ...
          <div className="lg:border bg-[#b7c84c] dark:bg-rose-500 p-5 lg:p-10">
            <ul className="flex flex-col gap-10">
              ...
              <li className="flex items-center gap-8">
                <img src="/images/phone.png" alt="" className="w-16 2xl:w-20" />
                <p className="dark:text-slate-300 font-medium">
              ...
              <li className="flex items-center gap-8">
                <img src="/images/map.png" alt="" className="w-16 2xl:w-20" />
                <p className="dark:text-slate-300 font-medium">
