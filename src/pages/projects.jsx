        ...
        <div className="w-full grid py-2 gap-10">
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-6">
            <div className="col-span-3 justify-self-center flex items-center">
              <img
                ...
                alt=""
                className="dark:border-slate-100 border-2 border-[#b7c84c] p-2 object-cover  "
              />
            </div>
            <div className="col-span-3 flex flex-col gap-6 p-10 text-center justify-center">
              ...
              <div>
                <button className="px-4 2xl:px-8 py-2 2xl:py-3 rounded-md dark:text-zinc-100 text-slate-800 font-bold dark:bg-rose-500 shadow-lg bg-[#b7c84c] dark:shadow-rose-500/50 shadow-[#070703] transition delay-150 duration-200 ease-in-out hover:-translate-y-1 hover:shadow-none text-xl">
          ...
          <div className="flex flex-col-reverse lg:grid lg:grid-cols-6">
            <div className="col-span-3 flex flex-col gap-6 p-10 text-center justify-center">
              ...
              <div>
                <button className="px-4 2xl:px-8 py-2 2xl:py-3 rounded-md dark:text-zinc-100 text-slate-800 font-bold dark:bg-rose-500 shadow-lg bg-[#b7c84c] dark:shadow-rose-500/50 shadow-[#070703] transition delay-150 duration-200 ease-in-out hover:-translate-y-1 hover:shadow-none text-xl">
                  <a href="https://github.com/purbarunBC13/MERN2023.git">
                    Check Codebase
                  </a>
                </button>
              </div>
